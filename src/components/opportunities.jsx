...
const Opportunities = () => {
  return (
    <div>
      <div className="min-h-full xl:h-fit xl:pt-12 xl:pb-20  py-6 px-0 flex flex-col xl:gap-8 w-full bg-gradient-to-r from-violet-400 via-indigo-400 to-blue-400 mb-12 xl:relative">
        <p className='xl:text-3xl lg:text-2xl text-white xl:px-24 px-auto text-center xl:text-left'>
          An Opportunities for Pre-Final Year Students Register Now!
        </p>
        <div className="flex flex-row xl:flex-row justify-center xl:justify-end items-center xl:p-20 xl:h-44 h-fit p-6 mt-6 gap-6">
          <img src={oppL} className='hidden xl:block xl:absolute h-56 left-24' alt="" />
          <div className="rounded-md bg-violet-100 p-4 flex flex-col justify-center xl:p-8 h-40 text-xl text-center xl:text-left xl:absolute xl:left-36 text-black xl:text-zinc-600">
          ...
          <div className="xl:flex xl:flex-row xl:justify-between xl:pl-72 xl:pr-16 xl:py-10 gap-6 xl:gap-10 text-xl xl:border xl:rounded-r-md xl:border-white xl:border-l-0 width-fit text-white">
